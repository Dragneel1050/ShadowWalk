...
def censysio(address):
    ID = "86661bb9-fdae-4c9f-81bd-f28d179adafa"                                 #provide Censys.io API ID
    SECRET = "bquVj85qjqH8JD3TFNKXFjDYXVdmtGcq"                                 #provide Censys.io API Secret
    page = 1
    data = []
    print('\n')
...
def zoomEye(address):
    try:
        zm = ZoomEye()
        zm.api_key='1EDfEC76-A2C7-2DB25-5293-572572C5d59'                       #provide ZoomEye API Key
...
def shod(address):
    try:
        ...
        print('\n')
        api = Shodan('9RWx8zgEg6cZ2mwE3IEX7KkmfHK7yFvj')                        #provide Shodan API Key
...
def securityTrails(address):
    try:
        ...
        headers = {"Accept": "application/json", "APIKEY" : "KGAzE5yffzMgbgFcW31XEUHhYsGn67i0"}                 #provide SecurityTrails Api Key
...
#     print('Searching on SecurityTrails.......')
#     print('\n')
#     url1 = "https://api.securitytrails.com/v1/history/yap.com/dns/a"
# #        url2 = "https://api.securitytrails.com/v1/domain/"+address+"/subdomains"

#     querystring = {"children_only":"false","include_inactive":"true"}

#     headers = {"Accept": "application/json", "APIKEY" : "KGAzE5yffzMgbgFcW31XEUHhYsGn67i0"}                 #provide SecurityTrails Api Key
#     response3 = requests.request("GET", url1, headers=headers)
#     aHList =[]
...
#         for org in records['organizations']:
#             organi.append(org)
#         for i,o in zip(ipList,organi):
#             ip = i
#             org = o
#             newList = [ip , fSeen, lSeen, org]
#             aHList.append(newList)
#     print("Historic DNS Record")
#     print(tabulate(aHList, headers=["IP", "FIRST SEEN", "LAST SEEN", "ORGANIZATION"]))
#     print('\n')
...
#        organi = records['organization'][0]
    #    for i in ipList:
    #        lSeen = records['last_seen']
    #        fSeen = records['first_seen']
    #        newList = [i, fSeen, lSeen]
    #        aHList.append(newList)
    #print("Historic DNS Record")
    #print(tabulate(aHList, headers=["IP", "FIRST SEEN", "LAST SEEN"]))
    #print('\n')
